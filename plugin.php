...
?>
		<div class="my-profile">
			...
			<div class="my-profile-thumb">
				<?php if($myprofile_id != '') : ?>
				  <a href="<?php echo $myprofile_url; ?>"><img src="<?php echo $cps_ranking01_img; ?>" alt="<?php echo $alt; ?>" width="110" height="110" loading="lazy" /></a>
				<?php else : ?>
					<img src="<?php echo $cps_ranking01_img; ?>" alt="<?php echo $alt; ?>" width="110" height="110" loading="lazy" />
				<?php endif; ?>
			</div>
